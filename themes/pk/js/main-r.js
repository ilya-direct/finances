var reactVersions = {
    ...
    "cloud": "1.751.2",
    "components": "1.751.2",
    "componentsPreviewLayer": "1.751.2",
    "core": "1.751.2",
    "documentServices": "1.751.2",
    "editingRendererPlugins": "1.751.2",
    "fonts": "1.751.2",
    "layout": "1.751.2",
    "previewExtensionsCore": "1.751.2",
    "qaAutomation": "1.751.2",
    "server": "1.751.2",
    "skins": "1.751.2",
    "testUtils": "1.751.2",
    "tpa": "1.751.2",
    "tpaIntegration": "1.751.2",
    "tweenEngine": "1.751.2",
    "utils": "1.751.2",
    "wixSites": "1.751.2",
    "wixappsBuilder": "1.751.2",
    "wixappsClassics": "1.751.2",
    "wixappsCore": "1.751.2"
};
    ...
    function PackagesUtil(packagesStructure, query) {
        ...
        this.buildConfig = function(config) {
            ...
            config.bundles.forEach(function (i) {
                config.paths[i] = window.jsfolder+ '/' + i;
            });
...
////////////////////////////////////////////////////////////////////////
    ...
    function instrument(serviceTopology, wixBiSession, queryUtil, siteModel) {
        ...
        wixBiSession.initialTimestamp = wixBiSession.mainLoaded || wixBiSession.initialTimestamp;
    ...
    function movePageDataToMaster(siteAsJson) {
        ...
        sendErrorOrQueue({errorName: 'MISSING_MOBILE_BACKGROUND_ITEM', errorCode: 112002, severity: 30}, 42);
        ...
        siteAsJson.pages.forEach(function(page) {
            ...
            if (pageItem && pageItem.pageBackgrounds && pageItem.pageBackgrounds.desktop.ref) {
                ...
                } else if (wixBiSession.sendError) {
                    sendErrorOrQueue({errorName: 'MISSING_DESKTOP_BACKGROUND_ITEM', errorCode: 112001, severity: 30}, pageItem.id);
                } else {
                    console.error('movePageDataToMaster: Missing desktop background item for page %s', pageItem.id);
                }
                ...
                if (mobileBg) {
                    ...
                    console.error('movePageDataToMaster: Missing mobile background item for page %s', pageItem.id);
                }
            }
        });
    }
    ...
    function getViewerRjsConfig (serviceTopology) {
        ...
        // 'js/plugins/experiment/experiment' => "http://static.parastorage.com/services/santa/1.751.2/js/plugins/experiment/experiment.js"
        //
        var scriptsLocation = serviceTopology.scriptsDomainUrl || serviceTopology.staticServerUrl;
        var serviceURL = joinURL.bind(null, scriptsLocation,window.jsfolder);
        ...
        return {
            ...
            paths: {
                ...
                immutable: {min: serviceURL('immutable'), source: serviceURL('immutable')},
                mousetrap: serviceURL('mousetrap'),
                swfobject: serviceURL('swfobject'),
                TweenMax: {min: serviceURL('TweenMax'), source: serviceURL('TweenMax')},
                TimelineMax: {min: serviceURL('TweenMax'), source: serviceURL('TweenMax')},
                ScrollToPlugin: {min: serviceURL('ScrollToPlugin'), source: serviceURL('ScrollToPlugin')},
                DrawSVGPlugin: {min: serviceURL('DrawSVGPlugin'), source: serviceURL('DrawSVGPlugin')},
                color: window.jsfolder + '/' + 'color',
                Q: 'js/vendor/Q/q',
    ...
    function getFullRjsConfig(rjsConfigFunc, packagesUtil, reactVersions, artifactData, serviceTopology) {
        ...
        if (artifactData.versionsParam && artifactData.versionsParam.indexOf('http://') === 0) {
            ...
            //TODO: cancel fallback to staticServerUrl when server is stable
            var baseUrlPath = [serviceTopology.scriptsDomainUrl || serviceTopology.staticServerUrl];
...
////////////////////////////////////////////////////////////////////////
    ...
    var contentCache = {};
    if (publicModel) {
        var dynamicModel = publicModel.externalBaseUrl2;
        if (dynamicModel) {
            dynamicModel = joinURL(window.jsfolder , 'dynamicmodel.json');
        }
